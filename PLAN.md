...
- 2026-09-26 UPDATE-213：A8 portability/diagnostic gate 修复后，Core benchmark/package/campaign suites 78 passed；F4 v6 synthetic suite 4 passed，但 candidate gate 重算有 3,680 个回归，保持 `not_justified`，未消费一次性 CPU/native canary 预检授权。只读总控 `can_finalize=false`、T1 缺 432、材料缺 288、正式训练缺 9，未写 registry/ledger。F8 V13–V15 均经 Terra High 配置只读复核为 `REVISE`、无 P0；V16 新增明确的版本效力矩阵、x86-64 synthetic-return、受控 launcher lineage/cgroup census、exec 前 inert FD pool、精确 fanotify mask/event-FD 及 file-cookie/final-fput join，等待 Terra High 独立复核。完整 syscall policy artifact、trusted supervisor 与 runtime observers 仍不存在。未启动 GenCase/native/solver/worker/GPU/queue、未做 root/sudo 或 host capability probe。详见 [UPDATE-213](lagrangian-fluid-lab/reports/CORE-CONTINUATION-STATUS-2026-09-26-UPDATE-213.zh-CN.md)、[合同 v14](lagrangian-fluid-lab/reports/F8-R008-TERMINAL-COMPLETION-EVIDENCE-CONTRACT-V14-2026-09-26.zh-CN.md)、[合同 v15](lagrangian-fluid-lab/reports/F8-R008-TERMINAL-COMPLETION-EVIDENCE-CONTRACT-V15-2026-09-26.zh-CN.md) 与 [合同 v16](lagrangian-fluid-lab/reports/F8-R008-TERMINAL-COMPLETION-EVIDENCE-CONTRACT-V16-2026-09-26.zh-CN.md)。

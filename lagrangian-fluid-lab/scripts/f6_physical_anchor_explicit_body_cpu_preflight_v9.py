#!/usr/bin/env python3
"""Run one CPU/native preflight for the F6 explicit-body v9 Definition."""
...
from scripts import f6_physical_anchor_explicit_body_root_review_v9 as review  # noqa: E402
...
def configure() -> None:
    ...
    runner.CASE_ID = "F6_physical_anchor_explicit_body_v9_cpu_native_preflight_20260921"
    runner.AUTHORIZATION_ID = "F6_physical_anchor_explicit_body_v9_cpu_native_preflight_authorization_20260921"

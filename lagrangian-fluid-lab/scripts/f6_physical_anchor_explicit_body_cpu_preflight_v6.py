#!/usr/bin/env python3
"""Run one CPU/native preflight for the F6 explicit-body v6 Definition."""
...
from scripts import f6_physical_anchor_explicit_body_root_review_v6 as review  # noqa: E402


ROOT = review.ROOT
OUTPUT = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-explicit-body-cpu-native-preflight-v6-20260921"


def configure() -> None:
    review.configure_base()
    runner.physical.FLUID_LOW = (0.18, 0.08, 0.04)
    runner.physical.FLUID_SIZE = (1.1399, 0.4399, 0.2399)
    runner.DEFINITION_ID = review.IDENTITY
    runner.BODY_ID = review.BODY_ID
    runner.CASE_ID = "F6_physical_anchor_explicit_body_v6_cpu_native_preflight_20260921"
    runner.AUTHORIZATION_ID = "F6_physical_anchor_explicit_body_v6_cpu_native_preflight_authorization_20260921"

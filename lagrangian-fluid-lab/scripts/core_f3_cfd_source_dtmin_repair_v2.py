...
def source_cases() -> dict[str, dict[str, Any]]:
    ...
    return {
        "f3_production_amp1p1_native002_dtminrepair_v1": _case(
            source_asset_id="f3_production_amp1p1_native002_dtminrepair_v1",
            case_id="F3_REV075_MATERIAL-AMP1P1-0075-DENSE002-DTMINREPAIR-V1",
            legacy_alias="F3_REV075_ENDPOINT-HIGH-0075-DENSE002-DTMINREPAIR-V1",
...
def _audit_hdf5(
    prepared: dict[str, Any], hdf5: Path, output: Path, *, prepared_path: Path,
) -> dict[str, Any]:
...
def run_case(prepared_path: Path, output: Path, *, lab: Path = LAB) -> dict[str, Any]:
    ...
    audit = _audit_hdf5(
        prepared, output / "trajectory.h5", output,

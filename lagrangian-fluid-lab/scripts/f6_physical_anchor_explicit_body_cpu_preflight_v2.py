#!/usr/bin/env python3
"""Run the one fresh CPU/native preflight for F6 explicit-body revision v2."""
...
from scripts import f6_physical_anchor_explicit_body_root_review_v2 as review  # noqa: E402


ROOT = review.ROOT
OUTPUT = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-explicit-body-cpu-native-preflight-v2-20260921"
...
def configure() -> None:
    ...
    runner.CASE_ID = "F6_physical_anchor_explicit_body_cpu_native_preflight_20260921"
    runner.AUTHORIZATION_ID = "F6_physical_anchor_explicit_body_cpu_native_preflight_authorization_20260921"
...
def main() -> int:
    configure()
    # The output directory is a fresh one-shot attempt.  The shared runner now
    # parses floating groups and enforces generated body metadata gates.

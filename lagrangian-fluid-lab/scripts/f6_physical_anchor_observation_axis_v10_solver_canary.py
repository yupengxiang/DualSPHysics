#!/usr/bin/env python3
"""Execute the single root-authorized CPU solver canary for F6 v10 observation axis.
...
JOB = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-observation-axis-v10-solver-canary-20260921/job.json"
REVIEW = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-observation-axis-v10-solver-canary-20260921/root-review.json"
DEFAULT_OUTPUT = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-observation-axis-v10-solver-canary-20260921/attempt-001"
...
def verify_authorization() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if job.get("scope_id") != SCOPE_ID:
        raise ValueError("solver-canary job is not bound to the fresh v10 scope")
...
def run(output: Path = DEFAULT_OUTPUT) -> dict[str, Any]:
    ...
    receipt = {
        ...
        "receipt_id": "F6_physical_anchor_observation_axis_v10_solver_canary_receipt_20260921",

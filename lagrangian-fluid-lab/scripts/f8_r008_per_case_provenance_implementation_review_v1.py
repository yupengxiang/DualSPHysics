#!/usr/bin/env python3
"""Archive the final Terra High static review binding for F8 R008 provenance."""
...
def verify_receipt(path: Path = OUTPUT) -> dict[str, Any]:
    ...
    if value != build_receipt():
        raise ValueError("immutable Terra High F8 R008 implementation review no longer matches source bytes")
    return value

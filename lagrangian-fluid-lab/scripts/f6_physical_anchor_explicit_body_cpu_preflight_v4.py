#!/usr/bin/env python3
"""Run one CPU/native preflight for the F6 explicit-body v4 Definition."""
...
from scripts import f6_physical_anchor_explicit_body_root_review_v4 as review  # noqa: E402


ROOT = review.ROOT
OUTPUT = LAB / "campaigns/core-v1/cfd/f6-fluid-rigid-body-physical-anchor-explicit-body-cpu-native-preflight-v4-20260921"
...
def configure() -> None:
    ...
    runner.CASE_ID = "F6_physical_anchor_explicit_body_v4_cpu_native_preflight_20260921"
    runner.AUTHORIZATION_ID = "F6_physical_anchor_explicit_body_v4_cpu_native_preflight_authorization_20260921"

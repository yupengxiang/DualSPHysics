...
机器回执：`/home/jade/Projects/DualSPHysics/lagrangian-fluid-lab/campaigns/core-v1/material/evidence/f4-tallwall120-t2-admission-acceptance-gap-audit-20260921.json`；SHA-256：`e5f910aa7a49d66f144b766a1dc3e7c00a03dda0ca3a668911d24449a9e0a3a5`。
...
- `core_material_acceptance.py` 的 per-source unknown 与通用 CDF difference 检查存在，但没有 tallwall120 schema/checkpoint-v2、residence CDF、F4 event tolerance、generation history 或逐矩阵 case acceptance。
...
9. core_material_acceptance does not admit the tallwall120 schema/checkpoint-v2 used by the versioned tallwall sidecar, so a complete future sidecar has no shared acceptance route
